    ...
    this.form = this.formBuilder.group({
      ...
      */
      ordemServicoItem: this.formBuilder.group({
        ...
        verificarComunicacaoIHM: [''],
        verificarOffSetSensorTemperaturaUmidade: [''],
        verificarValvulaBloqueioAguaGelada: [''],
        verificarAlimentacaoDrenoUmidificador: [''],
        testeDampers: ['', [Validators.required]],
        averiguarHistoricoEventosIHM: ['', [Validators.required]],
        verificarIsolamentoTermicasAcustico: ['', [Validators.required]],
        verificarEliminarPontosCorrosao: [''],
        verificarSistemaDrenagem: ['', [Validators.required]],
        limpeza: ['', [Validators.required]],
        painelEletrico: ['', [Validators.required]],
        serpentinaEvaporador: ['', [Validators.required]],
        gabinete: [''],
        filtroAr: ['', [Validators.required]],
        bandeja: ['', [Validators.required]],
        ruidosAnormaisEvaporador: ['', [Validators.required]],
